...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      -- LSP keymaps set per-buffer when a language server attaches
  ...
  { -- Autocompletion
    ...
    opts = {
      ...
      -- Use Lua fuzzy matcher (no prebuilt binary needed)
  ...
  { -- Highlight, edit, and navigate code
    ...
    config = function()
      ...
      local function treesitter_try_attach(buf, language)
        ...
        -- Enable treesitter based indentation if an indent query exists
